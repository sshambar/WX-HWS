...
.weather34indoorwarm{font-family:weathertext2,Arial,Helvetica,system;width:3rem;height:1rem;font-size:.9rem;padding-top:0;color:#fff;background:#ff832f;border:0;display:flex;align-items:center;justify-content:center;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;border-radius:3px;position:absolute;margin-left:60px;top:108px}
.weather34indoorcold{font-family:weathertext2,Arial,Helvetica,system;width:3rem;height:1rem;font-size:.9rem;padding-top:0;color:#fff;background:#00a4b4;border:0;display:flex;align-items:center;justify-content:center;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;border-radius:3px;position:absolute;margin-left:60px;top:108px}
.weather34indoormild{font-family:weathertext2,Arial,Helvetica,system;width:3rem;height:1rem;font-size:.75rem;padding-top:0;color:#fff;background:rgba(230, 161, 65, 1.000);border:0;display:flex;align-items:center;justify-content:center;-webkit-border-radius:2px;-moz-border-radius:2px;-o-border-radius:2px;border-radius:2px;position:absolute;margin-left:60px;top:108px}
.weather34indoorhot{font-family:weathertext2,Arial,Helvetica,system;width:3rem;height:1rem;font-size:.75rem;padding-top:0;color:#fff;background:rgba(211, 93, 78, 1.000);border:0;display:flex;align-items:center;justify-content:center;-webkit-border-radius:2px;-moz-border-radius:2px;-o-border-radius:2px;border-radius:2px;position:absolute;margin-left:60px;top:108px}
