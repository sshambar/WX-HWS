...
<html>
	<head>
		...
		<title>OUTDOOR Barometer MONTH CHART</title>
...
<body>
<div class="weather34darkbrowser" url="Barometer - <?php echo date('F Y') ;?> &nbsp;&nbsp;|&nbsp;&nbsp; High: <?php echo $weather["thb0seapressymax"]." ".$pressureunit ;?> &nbsp;&nbsp; Low: <?php echo $weather["thb0seapressymin"]." ".$pressureunit ;?>"></div>
