...
.w34convertrain{position:relative;font-size:.65em;top:12px;color:#c0c0c0;margin-left:5px}
...
margin-top:-40px;margin-left:92px;padding-left:3px;line-height:11px;font-size:10px}
...
<?php if ($meteobridgeapi[124]=='--'){echo $raininfo,"<blue>Rainfall</blue> N/A";}else echo " ".$rainlasttime?></div>
   ...
   <article> 
   <div class=actualt>&nbsp;Rain Year start&nbsp;<?php echo $rain_year_start ?> </div>      
  <?php // rain year
...
<a href="https://canvasjs.com" title="https://canvasjs.com" target="_blank" style="font-size:9px;"> Charts rendered and compiled using <?php echo $creditschart ;?> </a></span>
  ...
  <main class="grid1">
  <articlegraph> 
  <div class=actualt>&nbsp;&nbsp Today Rainfall Chart</div>  
  <iframe  src="wxcharts/todayrainfallsmall.php" frameborder="0" scrolling="no" width="100%"></iframe>
