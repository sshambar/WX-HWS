...
// NEW checkwx.com API 
if(file_exists('jsondata/metar34.txt')&&time()- filemtime('jsondata/metar34.txt')>1800){
$w34header= array(
...
?>
<?php
if(file_exists('jsondata/darksky.txt')&&time()- filemtime('jsondata/darksky.txt')>3600){
...
$ch4 = curl_init($url4);
$filename4 = 'jsondata/darksky.txt';
...
$filename1a = 'jsondata/eqnotification.txt';
...
$filename4a = 'jsondata/purpleair.txt';
...
$ch8 = curl_init($url8);
$filename8 = 'jsondata/weatherflow.txt';
