...
.windtoday,.windtoday10,.windtoday30,.windtoday40,.windtoday60{font-family:weathertext2,Arial,Helvetica,system;width:4rem;height:1.25rem;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;}.windtoday,.windtoday10,.windtoday30,.windtoday40,.windtoday60{font-size:.9rem;padding-top:5px;color:#fff;border-bottom:15px solid rgba(56,56,60,1);align-items:center;justify-content:center;text-align:center;border-radius:3px;}
...
smalluvunit{font-size:.55rem;font-family:Arial,Helvetica,system;}
...
if($weather["wind_units"] =='kts'){ echo number_format($weather["windamax"]*1.8519994254280931489,1)."<smalluvunit>km/h</smalluvunit>";}
?>
</div>
